...
def upgrade():
    ...
    existing_columns = [
        col["name"] for col in inspector.get_columns("marketplace_sessions")
    ]
    ...
    if "list_offset" not in existing_columns:
        ...
        print(
            "[Migration] list_offset already exists on marketplace_sessions - skipping"
        )
...
def downgrade():
    ...
    if "list_offset" in existing_columns:
        ...
        print(
            "[Migration] list_offset already absent from marketplace_sessions — skipping"
        )
